...
fn test_send_notification() {
    ...
    assert!(result.is_ok(), "Failed to send notification: {:?}", result.err());
}
...
fn test_send_notification_no_body() {
    ...
    assert!(result.is_ok(), "Failed to send notification without body: {:?}", result.err());
}
...
fn test_send_notification_critical() {
    ...
    assert!(result.is_ok(), "Failed to send critical notification: {:?}", result.err());
}
